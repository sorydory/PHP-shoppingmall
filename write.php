...
?>
        <div id="newPage2">
            <div id="writePage">
                <div id="writePage">
                    <h2>리뷰 작성하기</h2>
                    <form action="./process/write_process.php" method="post" enctype="multipart/form-data">
                        <table class="writeTable">
                            ...
                            <tr>
                                <td>내용</td>
                                <td>
                                    <textarea name="contents"cols="60" rows="15"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div id="writeBtn1">
                                        ...
                                        <button type="reset" value="취소"><a href="./review.php">취소</a></button>
                                    </div>
                                </td>
                            </tr>
                        </table>    
