...
<?php
    ...
    $sql = "select * from product where kinds like '카고/조거%'"; //글을 가져오는 갯수의 제한 30개//select한 값을 리턴받음
...
?>
    <div id="productPage">  
        <div id="title">
            <h1>카고/조거</h1>
            <ul id=tit_ul>
                <li><a href="./pants_cargojogger.php">카고/조거</a></li>
                <li><a href="./pants_training.php">트레이닝</a></li>
                <li><a href="./pants_basic.php">베이직</a></li>
            </ul>
        </div>
        <ul class="scrolls">
