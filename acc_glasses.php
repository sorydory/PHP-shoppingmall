...
<?php
    ...
    $sql = "select * from product where kinds like '안경/선글라스%'"; //글을 가져오는 갯수의 제한 30개//select한 값을 리턴받음
...
?>
    <div id="productPage">  
        <div id="title">
            <h1>안 경 / 선 글 라 스</h1>
            <ul id=tit_ul>
                <li><a href="./acc_muffler.php">넥타이</a></li>
                <li><a href="./acc_glasses.php">안경/선글라스</a></li>
                <li><a href="./acc_etc.php">기타</a></li>
            </ul>
        </div>
        <ul class="scrolls">
