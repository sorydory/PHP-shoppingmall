...
<?php
    ...
    $sql = "select * from product where kinds like '맨투맨/후드%'"; //글을 가져오는 갯수의 제한 30개//select한 값을 리턴받음
...
?>
    <div id="productPage">  
        <div id="title">
            <h1>맨 투 맨 / 후 드</h1>
            <ul id=tit_ul>
                <li><a href="./top_mantoman.php">맨투맨/후드</a></li>
                <li><a href="./top_knit.php">니트</a></li>
                <li><a href="./top_shirts.php">셔츠</a></li>
            </ul>
        </div>
        <ul class="scrolls">
