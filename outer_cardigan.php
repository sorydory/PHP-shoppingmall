...
<?php
    ...
    $sql = "select * from product where kinds like '가디건%'"; //글을 가져오는 갯수의 제한 30개//select한 값을 리턴받음
...
?>
    <div id="productPage">
        <div id="title">
            <h1>가 디 건</h1>
            <ul id=tit_ul>
                <li><a href="./outer_padding.php">패딩/점퍼</a></li>
                <li><a href="./outer_cardigan.php">가디건</a></li>
                <li><a href="./outer_coat.php">코트</a></li>
            </ul>
        </div>
        <ul class="scrolls">
